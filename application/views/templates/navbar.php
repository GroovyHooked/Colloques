    ...
    <div>
        <nav class="navbar w-100 d-flex flex-row justify-content-between">
            ...
            <button type="button" class="btn btn-success">
                <a class= "lien-edition" href="https://www.lalibrairie.com/livres/territoires-solidaires-en-commun_0-7025698_9782708253636.html?ctx=931ffac359ddba5891a69dc8e7b3af5b" >Acheter le livre</a></button>
